namespace HomeChef.API.Helpers;
...
public static class ResponseHelper
{
    public static IActionResult ToActionResult<T>(this ServiceResult<T> result)
    {
        ...
        return result.ErrorType switch
        {
            ...
            BusinessErrorType.PhoneNumberAlreadyExists => new BadRequestObjectResult(errorResponse),
            ...
            BusinessErrorType.PhoneNotConfirmed => new BadRequestObjectResult(errorResponse),
